...
* collapse (mean) manual limbs strength body language oral written cognitive perception visual hearing vocal [aw=howo], by(canton)

* set time panel data set using household number and year
* sort b015 year
* tsset b015 year
